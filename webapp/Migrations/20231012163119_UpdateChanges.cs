        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatchImageDiagnosisId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageRes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImageRes_BatchImageDiagnosis_BatchImageDiagnosisId",
                        column: x => x.BatchImageDiagnosisId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageRes_BatchImageDiagnosisId",
                table: "ImageRes",
                column: "BatchImageDiagnosisId");

            migrationBuilder.CreateIndex(
                name: "IX_Photo_BatchImageDiagnosisId",
                table: "Photo",
                column: "BatchImageDiagnosisId");
        }
